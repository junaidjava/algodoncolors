	            ...
	            <footer class="footer"> &copy; 2018 Algodon - All Rights Reserved. </footer>
	        </div>
	    </div>
    ...
    <script src="${contextPath}/resources/assets/plugins/datatables/buttons.print.min.js"></script>
    <script src="${contextPath}/resources/assets/plugins/datatables/dataTables.fixedHeader.min.js"></script>
    <script src="${contextPath}/resources/assets/plugins/datatables/dataTables.keyTable.min.js"></script>
